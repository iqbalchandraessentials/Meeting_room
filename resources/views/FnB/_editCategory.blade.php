            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="Food" placeholder="">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="c-inputs-stacked">
                            <input name="status" type="radio" id="status_active" value="1">
                            <label for="status_active" class="mr-30">Active</label>
                            <input name="status" type="radio" id="status_inactive" value="0" checked>
