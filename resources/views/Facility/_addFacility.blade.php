...
@section('breadcrumb')
    <div class="mr-auto w-p50">
        <h3 class="page-title border-0">Add New Facility</h3>
    </div>
@endsection
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="box">
                ...
                <form action="{{ route('store-menu-facilities')}}" method="post">
                    @csrf
                <div class="box-body">
                ...
                <div class="box-footer">
                    <div class="row">
                        <div class="col-3">
                            <button type="button" class="btn btn-pure btn-secondary btn-block" onclick="window.history.go(-1)">Cancel</button>
                        </div>
                        <div class="col-3">
                            <button type="submit" class="btn btn-pure btn-info float-right btn-block">Create</button>
                        </div>
                    </div>
                </div>
            </form>
