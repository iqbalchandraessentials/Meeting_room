            ...
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="row align-items-center">
                            <div class="col-sm-12 col-12">
                                <textarea class="form-control" rows="3" cols="3" placeholder="" readonly>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Sunt, numquam autem! Assumenda odit quae obcaecati non similique. Voluptatum mollitia delectus asperiores repellendus unde voluptates, beatae, ullam praesentium odio minima quod.</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="form-group mb-0">
                    ...
                    <div class="form-group mb-0">
                        <div class="row">
                            <div class="col-3">
                                <input type="text" name="guest_name" class="form-control" disabled value="Nero Jaida Janka" >
                            </div>
                            <div class="col-3">
                                <input type="text" name="guest_email" class="form-control" disabled value="nero.jaida@janka.com" >
                            </div>
                            <div class="col-3">
                                <input type="text" name="guest_company" class="form-control" disabled value="Nero Jaida Inc." >
                            </div>
                            <div class="col-3">
                                <input type="number" name="guset_phone" class="form-control" disabled value="081377662244" >
                            </div>
                        </div>
                    </div>
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="row">
                ...
                <div class="col-3">
                    <div class="form-group">
                        <a href="javascript:void(0);" class="btn btn-bold btn-pure btn-success btn-block">Approve</a>
                    </div>
                </div>
                <div class="col-3">
                    <div class="form-group">
                        <a href="javascript:void(0);" data-toggle="modal" data-target="#modalReason" class="btn btn-bold btn-pure btn-purple btn-block">Room Issue</a>
                    </div>
                </div>
                <div class="col-3">
                    <div class="form-group">
                        <a href="javascript:void(0);" data-toggle="modal" data-target="#modalReason" class="btn btn-bold btn-pure btn-danger btn-block">Reject</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group mb-0">
                                ...
                                <textarea class="form-control" rows="5" cols="5" placeholder=""></textarea>
                            </div>
                        </div>
                    </div>
                </div>
